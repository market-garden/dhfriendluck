                ...
                addUser:function(fUid, name, image) {
                        ...
                        if ($this.opts.selectType == "multiple") {
                                if ($.inArray(fUid, $this.resultArr) == -1) {
                                        ...
                                        $($this.opts.resultContainer).append("<a href='javascript:void(0)' name='" + fUid + "'><img width='20' height='20' src='" + image + "' title='" + fUid + "' alt='' />" + name + "<span title='移除该好友'>移除该好友</span></a>");
                                        ...
                                        var ggg_type = gg_type[0].substring(6,gg_type[0].length);
 										...
 										//水上铁09-10-09增加弹窗高度自适应功能
										var ym_height = $($this.opts.resultContainer).height()+310;
										parent.ymPrompt.resizeWin(500,ym_height); 
										//增加结束
