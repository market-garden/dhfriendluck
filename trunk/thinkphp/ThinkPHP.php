...
//2009-5-28 thinksns修改：修改缓存目录到根目录下
if(!defined('RUNTIME_PATH')) define('RUNTIME_PATH',THINK_PATH.'/../runtime/'.APP_NAME.'/');
define("THEME_PATH",THINK_PATH."/../public/theme_default");
define("ROOT_PATH",THINK_PATH."/..");
define('WEB_URL', THINK_PATH."/..");
define("__PUBLIC__",THINK_PATH."/../public");
define("__THEME__",THINK_PATH."/../public/theme_default");
//define("TS_URL",$_SERVER["SCRIPT_NAME"]."?s=");
//修改结束
