...
{//类定义开始
    ...
    private function build()
    {
		...
		// 匹配导入，公共函数文件 2009-7-20 thinksns修改
		$common_ext	=	glob(COMMON_PATH.'*.common.php');
		foreach($common_ext as $file){
			require $file;
			 if(!$debug)
                    $common   .= compile($file);
		}
    ...
    private function checkTemplate()
    {
        ...
        //当前网站地址
        define('__ROOT__',APP_ROOT);				//thinksns修改:	由WEB_URL 换成 APP_ROOT
        //当前项目地址
        ...
        if(C('APP_DOMAIN_DEPLOY')) {
            ...
            $appRoot   =  APP_URL.'/';	//thinksns修改:	由WEB_URL.'/'.APP_NAME 换成 APP_URL
        }
