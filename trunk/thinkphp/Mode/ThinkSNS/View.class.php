...
class View extends Base
{
   ...
   /**
    ...
    private function parseTemplatePath($content) {
        ...
        // 特殊变量替换，2009-5-31 直接增加__THEME__
        $content = str_replace(
            array('../Public', '__PUBLIC__',  '__TMPL__', '__ROOT__',  '__APP__',  '__URL__',   '__ACTION__', '__SELF__','__THEME__','__TS__'),
            array(APP_PUBLIC_URL, PUBLIC_URL, APP_TMPL_URL, ROOT_PATH, __APP__, __URL__, __ACTION__, __SELF__, THEME_URL, SITE_URL."/index.php?s="),
            $content
		);
    ...
    private function parseTemplateFile($templateFile) {
		...
		//2009-06-02修改
            ...
            // 引入其它模块的操作模板
            $templateFile   =   str_replace('&','/',$templateFile).C('TEMPLATE_SUFFIX');
        }elseif(strpos($templateFile,'#')){
