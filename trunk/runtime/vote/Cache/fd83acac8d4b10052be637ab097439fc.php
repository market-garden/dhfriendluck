...
<?php } ?>
  <div class="main"> <!-- 右侧内容 begin  -->
    <div class=page_title> <!-- page_title begin -->
      <h2><img src="../Public/images/ico_app06.gif" />投票</h2>
    <div class="c"></div>
</div><!-- page_title end -->
  ...
  <div class="tab-menu"><!-- 切换标签 begin  -->
      <ul>
      <li><a href="__URL__/my"><span>我的投票</span></a></li>
      <li><a href="__URL__/index" class="on"><span>好友的投票</span></a></li>
      <li><a href="__URL__/all"><span>大家的投票</span></a></li>
      <li><a href="__URL__/addPoll"><span><div class="ico_add">&nbsp;</div>发起投票</span></a></li>
      </ul>
  </div><!-- 切换标签 end  -->
  <div class="pollBox">
<div class="MenuSub"><a href="__URL__/index" <?php if (!isset( $_GET['action'] )) {echo "class='fB'";}else{echo "class='cGray'";} ?>>全部投票</a>┊<a href="__URL__/index/action/add" <?php if (isset( $_GET['action'] ) && 'add' == $_GET['action']) {echo "class='fB'";}else{echo "class='cGray'";} ?>>好友发起的投票</a>┊<a href="__URL__/index/action/in" <?php if (isset( $_GET['action'] ) && 'in' == $_GET['action']) {echo "class='fB'";}else{echo "class='cGray'";} ?>>好友参与的投票</a></div>

  <div class="LogList">
  		<ul>
            <?php if(is_array(is_array($votes)?$votes["data"]:$votes->data)): ?><?php $i = 0;?><?php $__LIST__ = is_array($votes)?$votes["data"]:$votes->data?><?php if( count($__LIST__)==0 ) : echo "" ; ?><?php else: ?><?php foreach($__LIST__ as $key=>$vo): ?><?php ++$i;?><?php $mod = ($i % 2 )?><li class="bg04">
          	<div class="box">
              <div class="c1"><span class="headpic50"><a href="__TS__/space/<?php echo ($vo["uid"]); ?>"  class="tips" rel="__TS__/Index/userInfo/uid/<?php echo ($vo['uid']); ?>"><img src="<?php echo (getUserFace($vo["uid"])); ?>" /></a></span><a href="__TS__/space/<?php echo ($vo["uid"]); ?>" class="U"><?php echo ($vo["name"]); ?></a></div>
          		<div class="left" style="width: 67%;">
                    <h3 class="f14px"><a href="__URL__/pollDetail/id/<?php echo ($vo["id"]); ?>" class="U"><strong><?php echo ($vo["title"]); ?></strong></a></h3>
                                                  <?php if(is_array(is_array($vo)?$vo["opts"]:$vo->opts)): ?><?php $i = 0;?><?php $__LIST__ = is_array($vo)?$vo["opts"]:$vo->opts?><?php if( count($__LIST__)==0 ) : echo "" ; ?><?php else: ?><?php foreach($__LIST__ as $key=>$opt): ?><?php ++$i;?><?php $mod = ($i % 2 )?><?php if($vo['type'] == "0"){ ?>
                                                  ...
                                                  <p><span class="right">此投票由<a href="__TS__/space/<?php echo ($vo["uid"]); ?>"><?php echo ($vo["name"]); ?></a>发起。</span><span class="cRed">已结束</span></p>
                                                  <?php }else{ ?>
                    <p><span class="right cGray2">发起时间：<?php echo (friendlyDate($vo["cTime"])); ?>&nbsp;投票：<?php echo ($vo["vote_num"]); ?></span>．．．</p>
                    <?php } ?>

            	</div>
                <div class="left alR" style="width: 18%;">
                  <p class="cGray2"><a href="__URL__/pollDetail/id/<?php echo ($vo["id"]); ?>">全部</a> ┊ <a href="__URL__/pollDetail/id/<?php echo ($vo["id"]); ?>#comment">评论(<?php echo ($vo["commentCount"]); ?>)</a></p>
                	<br />
                    <a href="__URL__/pollDetail/id/<?php echo ($vo["id"]); ?>" class="btna">去投票</a>              </div>
            </div>
       	  </li><?php endforeach; ?><?php endif; ?><?php else: echo "" ;?><?php endif; ?>
        </ul>
        <div id="Pagination" class="pagination"><?php echo ($votes["html"]); ?></div>
  </div><!-- LogList end  -->
  </div>
