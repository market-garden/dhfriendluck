...
<?php } ?>
    ...
    <div class="main"> <!-- 右侧内容 begin  -->
        <div class="page_title"> <!-- page_title begin -->
            <div class="left" style="width:66px;;"><span class="headpic50"><img src="<?php echo (getUserFace($uid)); ?>" /></span></div>
            <div class="left" style="width:660px;;">
                <h1><?php echo ($name); ?>的详细资料</h1>
                <p>
                    <a href="__APP__/space/<?php echo ($uid); ?>"><?php echo ($name); ?>的首页</a>
                    <?php if($mid == $uid){ ?>
                        <a href="__APP__/Info">详细资料修改</a>
                    <?php } ?>
                </p>
            </div>
            <div class="left lh30" style="width:100px;;"><a href="javascript:history.back( -1 )">&lt;&lt;返回上一页</a></div>
        <div class="c"></div>
</div><!-- page_title end -->
        <div class="data topline"><!-- 基本资料 begin  -->
            <?php if($userInfo_zh){ ?>
                <dl>
                    <dt>基本资料</dt>
                    <?php foreach($userInfo_zh as $k=>$v){ ?>
                    <?php if(($v)  !=  ""): ?><dd><div class="c1"><?php echo ($k); ?>：</div><div class="c2"></div>
                        <div class="c3"><?php echo ($v); ?></div>
                    </dd><?php endif; ?>
                    <?php } ?>
            ...
            <?php } ?>
             ...
             <?php if($userInfo_geren){ ?>
            <dl>
                <dt>个人情况</dt>
                <!--<dd><div class="c1">家乡：</div><div class="c2"><img src="../Public/images/photo_ico_hykj.gif" alt="仅我的好友可看到此项资料" width="13" height="12" /></div>
                    <div class="c3">beijing</div>
                </dd>-->

                <?php foreach($userInfo_geren as $k=>$v){ ?>
                <?php if(($v)  !=  ""): ?><dd><div class="c1"><?php echo ($k); ?>：</div><div class="c2"></div>
                    <div class="c3"><?php echo ($v); ?></div>
                </dd><?php endif; ?>
                <?php } ?>
              ...
              <?php } ?>
               ...
               <?php if($userInfo_links){ ?>
            <dl>
                <?php foreach($userInfo_links as $k=>$v){ ?>
                 <?php if(($v)  !=  ""): ?><dd><div class="c1"><?php echo ($k); ?>：</div><div class="c2"></div>
                    <div class="c3"><?php echo ($v); ?></div>
                </dd><?php endif; ?>
                 <?php } ?>
            ...
            <dl>
                <dt>教育背景</dt>
                <?php if(is_array($edus)): ?><?php $i = 0;?><?php $__LIST__ = $edus?><?php if( count($__LIST__)==0 ) : echo "" ; ?><?php else: ?><?php foreach($__LIST__ as $key=>$vo): ?><?php ++$i;?><?php $mod = ($i % 2 )?><?php if(($v)  !=  "vo"): ?><dd>
                        <div class="c1">&nbsp;</div><div class="c2">&nbsp;</div><div class="c3"><?php echo ($vo); ?></div>
                    </dd><?php endif; ?><?php endforeach; ?><?php endif; ?><?php else: echo "" ;?><?php endif; ?>
            ...
            <dl>
                <dt>工作信息</dt>
                <?php if(is_array($works)): ?><?php $i = 0;?><?php $__LIST__ = $works?><?php if( count($__LIST__)==0 ) : echo "" ; ?><?php else: ?><?php foreach($__LIST__ as $key=>$vo): ?><?php ++$i;?><?php $mod = ($i % 2 )?><?php if(($v)  !=  "vo"): ?><dd><div class="c1">&nbsp;</div>
                        <div class="c2">&nbsp;</div><div class="c3"><?php echo ($vo); ?></div>
                    </dd><?php endif; ?><?php endforeach; ?><?php endif; ?><?php else: echo "" ;?><?php endif; ?>
