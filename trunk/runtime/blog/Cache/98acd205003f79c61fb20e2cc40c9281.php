...
<?php } ?>
  <div class="main"><!-- 画布 begin  -->
    ...
    <div class=page_title> <!-- page_title begin -->
                        <h2><img src="<?php echo ($APPINFO['APP_ICON']); ?>" /><?php echo L("blog");?></h2>
    <div class="c"></div>
</div><!-- page_title end -->
    <div class="tab-menu"><!-- 切换标签 begin  -->
      <ul>
        <li><a href="__URL__/index" class="on" ><span><?php echo L("friends");?></span></a></li>
        <li><a href="__URL__/my" ><span><?php echo L("my");?></span></a></li>
        <?php if(($all)  ==  "true"): ?><li><a href="__URL__/all"><span><?php echo L("all");?></span></a></li><?php endif; ?>
        <li><a href="__URL__/addBlog"><span><div class="ico_add">&nbsp;</div><?php echo L("insertNew");?></span></a></li>
      </ul>
    </div><!-- 切换标签 end  -->
    <div class="BlogBox">
      <div class="MenuSub"><?php if( isset($mention) ){ ?><a href="__URL__/index" class="fB"><?php } ?>好友最新的<?php echo L("blog");?></a> | <?php if( !isset($mention) ){ ?><a href="__URL__/index/mention/do" class="fB"><?php } ?>提到好友的<?php echo L("blog");?></a></div>
      <div>
        <div class="sidebar">
            <?php if( !isset( $mention )){ ?>
			<?php echo W("FriendGroup",array('this_url'=>__APP__.'/Index/index'));?>
		  <?php } ?>
        </div>
        <div class="LogList"><!-- 好友日志 begin  -->
          <ul>
            ...
            <li class="btmline">
            <div class="left" style="width: 10%;"><span class="headpic50"><a href="__TS__/space/<?php echo ($vo['uid']); ?>"  class="tips" rel="__TS__/Index/userInfo/uid/<?php echo ($vo['uid']); ?>"><img src="<?php echo (getUserFace($vo['uid'])); ?>" /></a></span></div>
            <div class="left" style="width: 90%;">
                       <?php if( !((3 == $vo['private'] && $vo['uid'] != $mid) || (1 == $vo['private'] && !$api->friend_areFriends( $mid,$vo['uid'] ))) ){ ?>
              <h3 class="f14px lh30 bg4"><span class="right"> <a href="javascript:void(0)" class="BtnShare" 
                    onclick="ts_sharePop('<?php echo ($vo["id"]); ?>','__URL__')"><?php echo L("share");?></a></span><a href="__URL__/show/id/<?php echo ($vo['id']); ?>/mid/<?php echo ($vo['uid']); ?>"><strong><?php echo ($vo['title']); ?></strong></a></h3>
              	<?php } ?>
              <p>
              <a href="__TS__/space/<?php echo ($vo['uid']); ?>"><?php echo ($vo['name']); ?></a> <span class="cGray2"><?php echo (friendlyDate($vo['cTime'])); ?></span>
              </p>
              <?php if( $vo['private'] == 3 && $vo['uid'] != $mid){ ?>
              ...
              <?php }else{ ?>
              <?php if( $vo['type'] != 0 ){ ?><span class="imported-article cGray2"><?php echo L("type1");?><?php } ?></span>
              <p style="margin:5px 0px; line-height:180%" class="f14px"><?php echo ($vo['content']); ?></p>
              <?php if(($vo['mention'])  !=  ""): ?><p class="cGray2"><?php echo L("mention");?>: 
              <?php foreach( $vo['mention'] as $friends ){ ?>
              <a href="__TS__/space/<?php echo ($friends['uid']); ?>"><?php echo ($friends['name']); ?></a>
              <?php } ?>
              </p><?php endif; ?>
              ...
              <a href="__URL__/personal/uid/<?php echo ($vo['uid']); ?>/cateId/<?php echo ($vo['category']['id']); ?>"><?php echo ($vo['category']['name']); ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;
              <a href="__URL__/show/id/<?php echo ($vo['id']); ?>/mid/<?php echo ($vo['uid']); ?>"><?php echo L("reader");?></a>(<?php echo ($vo['readCount']); ?>)&nbsp;&nbsp;|&nbsp;&nbsp;<a href="__URL__/show/id/<?php echo ($vo['id']); ?>/mid/<?php echo ($vo['uid']); ?>#comment"><?php echo L("comment");?></a>(<?php echo ($vo['commentCount']); ?>)</p>
            </div>
            </li>
            <?php } ?>
          </ul>
