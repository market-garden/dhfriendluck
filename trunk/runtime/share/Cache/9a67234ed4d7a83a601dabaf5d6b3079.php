<link rel="stylesheet" href="__PUBLIC__/js/friend_suggest/ui.friendsuggest.css" type="text/css" media="screen" charset="utf-8" />


<?php if(!$no){ ?>
	<script type="text/javascript" src="__PUBLIC__/js/friend_suggest/ui.friendsuggest.js"></script>
...
<script>
    $(document).ready( function(){
        ...
        var test = new giant.ui.friendsuggest({
            ...
            ajaxUrl: TS + "/Friend/ajax",
            ajaxLoadAllUrl: TS + "/Friend/getAllFriends",
            ajaxGetCountUrl: TS + "/Friend/getCountUrl",
            ajaxGetFriendTypeUrl: TS + "/Friend/getFriendType",
	...
	<div class="ui-fs-all">
		...
		<div class="ui-fs-allinner">
			<div class="page clearfix">
				<!--<div class="llight1">还有<b id="ui_fri_num">5</b>人可选</div>--><div class="button"><span class="prev">上一页</span><span class="next">下一页</span></div>
			</div>
