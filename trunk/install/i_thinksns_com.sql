...
INSERT INTO `ts_app` VALUES ('3', '心情', 'mini', 'http://{APP_URL}/appinfo/ico_app04.gif', 'http://{APPS_URL}/mini', 'index.php?s=', 'http://{APP_URL}/index.php?s=Admin', 'http://{APP_URL}/index.php?s=/Index/friends/uid/', '', '', 'sam', '心情', '5', '0', '0', '', null);
INSERT INTO `ts_app` VALUES ('4', '日志', 'blog', 'http://{APP_URL}/appinfo/ico_app01.gif', 'http://{APPS_URL}/blog', 'index.php?s=', 'http://{APP_URL}/index.php?s=Admin', 'http://{APP_URL}/index.php?s=/Index/personal/uid/', 'http://{APP_URL}/index.php?s=Index/addBlog', '发表', 'sam', '想分享你的文章给你的好友么，快来记录日志吧', '1', '0', '0', '', null);
INSERT INTO `ts_app` VALUES ('10', '相册', 'photo', 'http://{APP_URL}/appinfo/ico_app02.gif', 'http://{APPS_URL}/photo', 'index.php?s=', 'http://{APP_URL}/index.php?s=Admin', 'http://{APP_URL}/index.php?s=/Index/photos/uid/', 'http://{APP_URL}/index.php/Upload/flash', '上传', 'sam', '分享你的图片给好友吧', '4', '0', '0', '', null);
INSERT INTO `ts_app` VALUES ('11', '分享', 'share', 'http://{APP_URL}/appinfo/ico_app_share.gif', 'http://{APPS_URL}/share', 'index.php?s=', 'http://{APP_URL}/index.php?s=Admin', 'http://{APP_URL}/index.php?s=/Index/personal/uid/', '', '', 'wxh', '分享视频，网址，图片', '2', '0', '0', '', null);
INSERT INTO `ts_app` VALUES ('12', '群组', 'group', 'http://{APP_URL}/appinfo/ico_app05.gif', 'http://{APPS_URL}/group', 'index.php?s=', 'http://{APP_URL}/index.php?s=Admin', 'http://{APP_URL}/index.php?s=/SomeOne/index/uid/', '', '', 'shg', '创建你自己群组，邀请三五好友，讨论你们感兴趣的话题吧', '7', '0', '0', '', null);
INSERT INTO `ts_app` VALUES ('13', '投票', 'vote', 'http://{APP_URL}/appinfo/ico_app06.gif', 'http://{APPS_URL}/vote', 'index.php?s=', 'http://{APP_URL}/index.php?s=Admin', 'http://{APP_URL}/index.php?s=/Index/personal/uid/', 'http://{APP_URL}/index.php?s=/Index/addPoll', '发起', 'sam', '投票', '6', '0', '0', '', null);
INSERT INTO `ts_app` VALUES ('14', '活动', 'event', 'http://{APP_URL}/appinfo/ico_app07.gif', 'http://{APPS_URL}/event', 'index.php?s=', 'http://{APP_URL}/index.php?s=Admin', 'http://{APP_URL}/index.php?s=/Index/personal/uid/', 'http://{APP_URL}/index.php?s=/Index/addEvent', '发起', 'sam', '想组织你的站内好友一起来活动么，快快来参与吧！', '8', '0', '0', '', null);
INSERT INTO `ts_app` VALUES ('17', '礼品', 'gift', 'http://{APP_URL}/appinfo/ico_apply.gif', 'http://{APPS_URL}/gift', 'index.php?s=', 'http://{APP_URL}/index.php?s=Admin', 'http://{APP_URL}/index.php?s=/Index/personal/uid/', 'http://{APP_URL}/index.php?s=/Index/index/uid/', '', '水上人', '礼品', '1', '0', '0', null, null);
...
CREATE TABLE `ts_edu_search` (
  ...
  `extra1` varchar(255) character set utf8 NOT NULL,
  `extra2` varchar(255) character set utf8 NOT NULL,
...
INSERT INTO `ts_event_type` (`id`, `name`) VALUES (1, '音乐/演出'),
(2, '展览'),
(3, '电影'),
(4, '讲座/沙龙'),
(5, '戏剧/曲艺'),
...
INSERT INTO `ts_info_category` VALUES ('1', 'info', '网站信息', '0', '', '', '', null);
INSERT INTO `ts_info_category` VALUES ('2', 'about', '关于我们', '1', '', '', '', null);
INSERT INTO `ts_info_category` VALUES ('3', 'contact', '联系方式', '1', '', '', '', null);
INSERT INTO `ts_info_category` VALUES ('6', 'help', '帮助', '0', '', '', '', null);
INSERT INTO `ts_info_category` VALUES ('7', '', '注册成为会员', '6', '', '', '', null);
INSERT INTO `ts_info_category` VALUES ('8', '', '网站功能', '6', '', '', '', null);
INSERT INTO `ts_info_category` VALUES ('9', '', '其它', '6', '', '', '', null);
INSERT INTO `ts_info_category` VALUES ('10', '', '网站公告', '0', '', '', '', null);
INSERT INTO `ts_info_category` VALUES ('11', 'broadcast', '官方公告', '0', '', '', '', null);
...
CREATE TABLE `ts_notify` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=10602 DEFAULT CHARSET=utf8;
...
INSERT INTO `ts_option` VALUES ('email', 'shoutaimu@thinksns.com', 'thinksns');
...
INSERT INTO `ts_option` VALUES ('emap_port', null, 'thinksns');
...
CREATE TABLE `ts_user_online` (
  ...
  PRIMARY KEY  (`id`),
  UNIQUE KEY `uid` (`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=4563 DEFAULT CHARSET=utf8;
