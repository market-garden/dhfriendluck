...
function add(){
 location.href = URL+"/add/"+"?returnUrl="+SELF;
}

function addNetwork(pid){
 location.href = URL+"/add/pid/"+pid;
}
...
function forbid(id){
	...
	location.href = URL+"/forbid/id/"+keyValue+"/?returnUrl="+SELF;
}
...
function resume(id){
	...
	location.href = URL+"/resume/id/"+keyValue+"/?returnUrl="+SELF;
}
...
function edit(id){
	...
	location.href =  URL+"/edit/id/"+keyValue+"/?returnUrl="+SELF;
}
...
function del(id){
	...
	{	
		location.href = URL+"/delete/id/"+keyValue+"/?returnUrl="+SELF;
	}
}


function remove(id,tbname){
	...
	if (window.confirm('确实要删除选择项吗？'))
	{	
		location.href = URL+"/delete/id/"+keyValue+"/tbname/"+tbname+"/?returnUrl="+SELF;
	}
}
