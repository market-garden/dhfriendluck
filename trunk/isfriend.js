	  function isFriend() {
		   ...
		   opt_params[opensocial.DataRequest.PeopleRequestFields.FILTER_OPTIONS] = opensocial.DataRequest.FilterType.IS_FRIENDS_WITH;
           opt_params[opensocial.DataRequest.PeopleRequestFields.FILTER] = withfriendid;
		   //req.add(req.newFetchPersonRequest(opensocial.IdSpec.PersonId.OWNER), 'ow');
